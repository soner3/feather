...
public class SecurityConfig {
        ...
        protected SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http,
                ...
                http
                                ...
                                // exception.authenticationEntryPoint(tokenAuthEntryPoint))
        ...
        @Bean
        public OAuth2TokenCustomizer<JwtEncodingContext> jwtTokenCustomizer(OidcUserInfoService oidcUserInfoService) {
                return (context) -> {
